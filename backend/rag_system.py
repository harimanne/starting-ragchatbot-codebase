...
from search_tools import ToolManager, CourseSearchTool, CourseOutlineTool, ListCoursesTool
...
class RAGSystem:
    ...
    def __init__(self, config):
        ...
        self.list_courses_tool = ListCoursesTool(self.vector_store)
        self.tool_manager.register_tool(self.list_courses_tool)
